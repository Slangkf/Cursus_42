...
/*   Updated: 2025/09/19 08:33:15 by tclouet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    //The AAnimal class is now abstract, so we cannot instantiate it.
    //This should not compiling : AAnimal    a; or const    AAnimal*    a = new AAnimal();
    //But the rest of the derived classes should work as in the previous exercise.
    ...
    const AAnimal* ad = new Dog();
    const AAnimal* ac = new Cat();
    std::cout << std::endl;
